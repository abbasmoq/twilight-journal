  ...
  async function loadApproved() {
    ...
    section.innerHTML = `
      <div class="approved-heading">
        <div><h2>Upcoming Journals</h2><p class="approved-fa">بازی‌های تأییدشده برای ساخت دفترچه‌های بعدی</p></div>
      ...
      grid.innerHTML = data.map(game => `
        <article class="approved-game">
          ...
          <div class="approved-body">
            ...
            <span class="coming-badge">Journal Coming Soon</span>
          </div>
        </article>
      `).join("");
    }
